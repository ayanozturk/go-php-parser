...
| Unknown methods on typed receivers | Differential-gated at level 2 | `unknown-method-typed-parameter`, `unknown-method-assigned-new`, `unknown-method-direct-new`, `unknown-method-return-chain`, `unknown-method-typed-property`, `unknown-method-named-function-chain`, `unknown-method-ternary-receiver`, `unknown-method-union-all-missing`, `unknown-method-intersection-all-missing`, `unknown-method-dnf-all-missing`, `unknown-method-nullable-receiver`, `unknown-method-ternary-null-receiver` | `PHPStan.Level2.MethodExistence` | `method.notFound` | Covers typed parameters, variables assigned from `new`, direct `new` expressions, method and named-function return chains, typed property chains, class-only and nullable ternaries, nullable class receivers, and union/intersection/DNF receivers where every resolved class lacks the method. Variable calls, dynamic construction, and other non-object branches remain conservative. |
...
| --- | --- | --- |
| Complete arbitrary-expression unknown method checks | Partial | Extend facts to variable callable returns, dynamic `class-string<T>` construction, other non-object branches, and remaining expression forms; gate higher-level per-alternative DNF availability separately |
