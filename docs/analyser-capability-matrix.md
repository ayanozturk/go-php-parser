...
| Unknown methods on typed receivers | Differential-gated at level 2 | `unknown-method-typed-parameter`, `unknown-method-assigned-new`, `unknown-method-direct-new`, `unknown-method-return-chain`, `unknown-method-typed-property`, `unknown-method-named-function-chain`, `unknown-method-ternary-receiver`, `unknown-method-union-all-missing`, `unknown-method-intersection-all-missing`, `unknown-method-dnf-all-missing`, `unknown-method-nullable-receiver`, `unknown-method-ternary-null-receiver`, `unknown-method-callable-variable`, `unknown-method-closure-variable`, `unknown-method-dynamic-class-string`, `unknown-method-callable-property`, `unknown-method-callable-array-shape`, `unknown-method-callable-method-return`, `unknown-method-template-class-string` | `PHPStan.Level2.MethodExistence` | `method.notFound` | Covers typed parameters, variables assigned from `new`, direct, assigned, concrete, and template-bounded `class-string<T>` dynamic construction, method, named-function, PHPDoc callable-variable, callable-property, callable-array-shape, and assigned closure or declared-callable return chains, typed property chains, class-only and nullable ternaries, nullable class receivers, and union/intersection/DNF receivers where every resolved class lacks the method. Nested/dynamic shapes, other non-object branches, and remaining expression forms remain conservative. |
| Known or conservative method receivers | Differential-gated at level 2 | `known-method-receiver`, `mixed-method-receiver`, `union-method-receiver`, `known-method-intersection-receiver`, `known-method-dnf-member`, `known-method-nullable-receiver`, `known-method-callable-variable`, `known-method-closure-variable`, `known-method-dynamic-class-string`, `known-method-callable-property`, `known-method-callable-array-shape`, `known-method-callable-method-return`, `known-method-template-class-string` | none | none | Known and nullable-known methods, `mixed`, and union/intersection/DNF receivers where any member provides the method remain clean, matching the pinned level-2 boundary. Per-alternative DNF availability begins above level 2 and is not yet gated. |
...
| --- | --- | --- |
| Complete arbitrary-expression unknown method checks | Partial | Extend facts to nested/dynamic array shapes, remaining non-object receiver branches, and remaining expression forms; gate higher-level per-alternative DNF availability separately |
