...
<!-- rule-inventory: unlevelled=4 levelled=23 total=27 -->
...
- **Cumulative registered levelled rules:** 23 (unchanged; these rules are not part of that total).
- **Total registered analysis rules:** 27, consisting of 23 levelled rules and these 4 unlevelled rules.
