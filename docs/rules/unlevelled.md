...
<!-- rule-inventory: unlevelled=4 levelled=32 total=36 -->
...
- **Cumulative registered levelled rules:** 32 (unchanged; these rules are not part of that total).
- **Total registered analysis rules:** 36, consisting of 32 levelled rules and these 4 unlevelled rules.
