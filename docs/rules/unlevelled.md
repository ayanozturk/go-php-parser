...
<!-- rule-inventory: unlevelled=4 levelled=18 total=22 -->
...
- **Cumulative registered levelled rules:** 18 (unchanged; these rules are not part of that total).
- **Total registered analysis rules:** 22, consisting of 18 levelled rules and these 4 unlevelled rules.
