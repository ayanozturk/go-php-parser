...
<!-- rule-inventory: unlevelled=4 levelled=17 total=21 -->
...
- **Cumulative registered levelled rules:** 17 (unchanged; these rules are not part of that total).
- **Total registered analysis rules:** 21, consisting of 17 levelled rules and these 4 unlevelled rules.
