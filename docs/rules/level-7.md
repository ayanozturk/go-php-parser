...
<!-- rule-inventory: level=7 introduced=1 cumulative=26 -->
...
- **Cumulative registered levelled rules:** 26.
...
Levels 0 through 6 are cumulative. Level 5 adds no registered rules; level 6 adds focused missing-type checks.
