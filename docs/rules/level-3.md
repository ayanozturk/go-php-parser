...
<!-- rule-inventory: level=3 introduced=5 cumulative=21 -->
...
- **Cumulative registered levelled rules:** 21. The assignment, binary-operation, void-purity, method, and PHPDoc rules from level 2 are cumulative and are not introduced here.
