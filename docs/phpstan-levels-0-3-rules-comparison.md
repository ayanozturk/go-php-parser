...
1. Complete PHPStan 2.2.x level-0 rule parity across all registered rule classes, especially modifier legality, constructor consistency, readonly property edge cases, class constant legality, enum-specific rules, and PHPStan API restriction rules.
