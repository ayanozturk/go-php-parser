...
| Class model and `$this` methods | Extending final classes, implementing unknown interfaces, undefined `$this` methods, invalid class/method modifier combinations, constructor return types, non-public interface methods, and missing required interface/abstract parent methods. |
