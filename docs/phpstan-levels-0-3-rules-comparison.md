...
| 5 | Function, method, and constructor argument types | Partial, differential-gated | `A.ARG.TYPE` | Eleven fixtures covering mismatches plus scalar, subtype, `self`, generic Collection, and unbound template-return controls. Failing cases are silent at level 4. |
...
| `A.ARG.TYPE` | Checks resolved named-function, method, and constructor argument value types against declared parameter types. | Partial PHPStan level 5 coverage, gated by eleven fixtures. |
