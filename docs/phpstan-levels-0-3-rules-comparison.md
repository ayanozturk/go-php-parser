...
| Class model and `$this` methods | Extending final classes, implementing unknown interfaces, undefined `$this` methods, invalid class/method modifier combinations, constructor return types, and non-public interface methods. |
