...
| 5 | Function, method, and constructor argument types | Partial, differential-gated | `A.ARG.TYPE` | Six original fixtures plus `self` parameter clean/mismatch controls. Failing cases are silent at level 4. |
