...
func (p *Parser) parseFQCNExpression() ast.Node {
	fqcnPos := p.tok.Pos
	fqcn := ""
	for {
...
func (p *Parser) parseBooleanLiteral(value bool) ast.Node {
...
func (p *Parser) parseVariableExpression() ast.Node {
