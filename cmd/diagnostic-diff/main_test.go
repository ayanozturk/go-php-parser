...
func TestCheckedInEngineDifferentialBaseline(t *testing.T) {
	...
	if level0Report.Totals.Cases != 88 {
		t.Fatalf("expected 88 level-0 differential cases, got %d", level0Report.Totals.Cases)
	}
	...
	if level2Report.Totals.Cases != 72 || level2Report.Totals.EngineMismatches != 0 {
	...
	if level3Report.Totals.Cases != 22 || level3Report.Totals.EngineMismatches != 0 {
