...
func TestCheckedInEngineDifferentialBaseline(t *testing.T) {
	...
	if level5Report.Totals.Cases != 13 || level5Report.Totals.EngineMismatches != 0 {
	...
	if level7Report.Totals.Cases != 6 || level7Report.Totals.EngineMismatches != 0 {
	...
	if level8Report.Totals.Cases != 27 || level8Report.Totals.EngineMismatches != 0 {
