...
func TestCheckedInEngineDifferentialBaseline(t *testing.T) {
	...
	if level3Report.Totals.Cases != 40 || level3Report.Totals.EngineMismatches != 0 {
	...
	if level5Report.Totals.Cases != 46 || level5Report.Totals.EngineMismatches != 0 {
	...
	if level6Report.Totals.Cases != 23 || level6Report.Totals.EngineMismatches != 0 {
