...
func (d *DeclareNode) GetEndPos() Position    { return d.EndPos }
func (d *DeclareNode) SetEndPos(pos Position) { d.EndPos = pos }
...
func (d *DeclareDirective) GetEndPos() Position    { return d.EndPos }
func (d *DeclareDirective) SetEndPos(pos Position) { d.EndPos = pos }
